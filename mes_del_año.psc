Proceso mes_del_ano 
	...
	Si Mes >= 1 y Mes <= 7 Entonces
		Segun Mes  Hacer
			...
			2:
				Escribir "Febrero es el segundo mes del año en el calendario gregoriano y tiene 28 días y";
				Escribir "29 en los años bisiestos.";
			3:
				Escribir "Marzo es el tercer mes del año en el calendario gregoriano y tiene 31 días.";
			4:
				Escribir "Abril es el cuarto mes del año en el calendario gregoriano y tiene días.";
			5:
			...
			10:
				Escribir "Octubre es el décimo y antepenultimo mes del año en el calendario gregoriano y tiene 31 días.";
			11:
